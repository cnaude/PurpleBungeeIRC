/* 
* Override BungeeCord's security manager with this.
*/
...
public class PurpleSecurityManager extends SecurityManager {
    ...
    private void checkRestricted(String text) {
        ...
        for (int i = 2; i < context.length; i++) {
            ...
            if (loader == null) {
                if (!context[i].getName().startsWith("java") || !context[i].getName().contains("pircbot")) {
                    break;
                }
            }
